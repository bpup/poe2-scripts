...
_KEY_TABLE: Dict[str, _KeyInfo] = {
    # WASD movement (lowercase — used directly for navigation)
    "w": (0x57, 0x11),
    "a": (0x41, 0x1E),
    "s": (0x53, 0x1F),
    "d": (0x44, 0x20),
    ...
    "TAB":   (0x09, 0x0F),
    "ESC":   (0x1B, 0x01),
    # Skill keys (uppercase convention used in config)
    "Q": (0x51, 0x10),
    "W": (0x57, 0x11),  # uppercase alias — same key as "w"
    "E": (0x45, 0x12),
    "R": (0x52, 0x13),
    "T": (0x54, 0x14),
    "F": (0x46, 0x21),
    "G": (0x47, 0x22),
    # Number row (flasks / extra skill slots)
    "1": (0x31, 0x02),
    "2": (0x32, 0x03),
    "3": (0x33, 0x04),
    "4": (0x34, 0x05),
